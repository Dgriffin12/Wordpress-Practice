...
class WonderPlugin_Slider_Model {
	...
	function generate_body_code($id, $has_wrapper) {
		...
		if ($item_row != null)
		{
			...
			$boolOptions = array('autoplay', 'randomplay', 'autoplayvideo', 'isresponsive', 'fullwidth', 'showtext', 'showtimer', 'showbottomshadow', 'navshowpreview', 'textautohide',
			...
			if ('F' == 'F')
				$ret .= '<div class="wonderplugin-engine">' . get_option('wonderplugin-slider-engine') . '</a></div>';
			$ret .= '</div>';
