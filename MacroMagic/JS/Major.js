...
function display_diary(day)
{
	if(logged_in)
	{
	     $.ajax({
	     	method: 'get',
	     	url: 'http://localhost/WP/MacroMagic/PHP/show_diary.php',
	     	data: {
	     		'day' : day,
	     		'username' : cur_user
	     	},
...
function add_entry(food_NDB_No)
{
	...
	$.ajax({
		method: 'get',
		url: 'http://localhost/WP/MacroMagic/PHP/add_entry.php',
		data: {
			'NDB_No' : food_NDB_No,
			'username': cur_user,
			'weight' : weight,
...
function remove_entry(iddiary_entry)
{
	$.ajax({
		method: 'get',
		url: 'http://localhost/WP/MacroMagic/PHP/remove_entry.php',
		data: {
			'id' : iddiary_entry,
			'day' : cur_day
		},
...
function view_goals()
{
	$.ajax({
		method: 'get',
		url: 'http://localhost/WP/MacroMagic/PHP/fetch_goals.php',
		data: {
			'cur_user' : cur_user
		},
		success: function(data){
...
function set_protein_goal(number_in_grams)
{
	$.ajax({
		method: 'get',
		url: 'http://localhost/WP/MacroMagic/PHP/update_goals.php',
		data: {
			'type' : "protein",
...
function intake_table_update()
{
	if(cur_user !== "")
	{
		$.ajax({
			method: 'get',
			url: 'http://localhost/WP/MacroMagic/PHP/daily_intake.php',
			data: {
				'username' : cur_user,
				'day' : cur_day
			},
