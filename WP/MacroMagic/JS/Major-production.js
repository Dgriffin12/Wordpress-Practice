...
function create_account(username, password)
{
	...
	$.ajax({
		method: 'post',
		url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/MacroMagic/PHP/create_acc.php',
		data: {
			'username' : username,
			'password' : password,
		},
...
function login(acc, pw){
	...
	$.ajax({
		method: 'get',
		url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/PHP/login.php',
		data: {
			'username' : username,
			'password' : password,
		},
...
function create_and_store_cookie()
{
	...
	$.ajax({
		method: 'get',
		url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/PHP/store_cookie.php',
		data: {
			'cookie' : cookie
		},
		success: function()
...
function search(data)
{
	...
	if (search_string=="" || search_string == "Search for Food") 
	{
  	...
  	$.ajax({
  		method: 'GET',
  		url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/PHP/search.php',
  		data:{	
  			'q' : search_string,
  			'k' : logged_in
  		},
...
function info(food_NDB_No, weight)
{
	$.ajax({
		method: 'get',
		url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/PHP/food_data_lookup.php',
		data: {
			'NDB_No' : food_NDB_No,
			'logged_in': logged_in,
			'weight' : weight
...
function nutrition_update(food_NDB_No, food_weight)
{
	...
	$.ajax({
		method: 'get',
		url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/PHP/nutrition_update.php',
		data: {
			'NDB_No' : food_NDB_No
		},
		success:function(data){
...
function logout()
{
	...
	$.ajax({
		method: 'get',
		url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/PHP/cookie_logout.php',
		data: {
			'username' : username,
			'long_num' : long_num
		}
...
function cookie_login_attempt(data1)
{
	...
	$.ajax({
		method: 'get',
		url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/MacroMagic/PHP/cookie_login.php',
		data: {
			'username' : username,
			'long_num' : long_num,
		},
...
function display_diary(day)
{
	if(logged_in)
	{
	     $.ajax({
	     	method: 'get',
	     	url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/MacroMagic/PHP/show_diary.php',
	     	data: {
	     		'day' : day,
	     		'username' : cur_user
	     	},
	...
	{
		$("#Diary").html('Please Log in above or <a href="http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/MacroMagic/wordpress/macromagic/create-account" title="Create Account">create an account</a> to view your food diary!');
	}	
}
...
function add_entry(food_NDB_No)
{
	...
	$.ajax({
		method: 'get',
		url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/MacroMagic/PHP/add_entry.php',
		data: {
			'NDB_No' : food_NDB_No,
			'username': cur_user,
			'weight' : weight,
...
function remove_entry(iddiary_entry)
{
	$.ajax({
		method: 'get',
		url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/MacroMagic/PHP/remove_entry.php',
		data: {
			'id' : iddiary_entry,
			'day' : cur_day
		},
...
function view_goals()
{
	$.ajax({
		method: 'get',
		url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/MacroMagic/PHP/fetch_goals.php',
		data: {
			'cur_user' : cur_user
		},
		success: function(data){
...
function set_protein_goal(number_in_grams)
{
	$.ajax({
		method: 'get',
		url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/MacroMagic/PHP/update_goals.php',
		data: {
			'type' : "protein",
...
function intake_table_update()
{
	if(cur_user !== "")
	{
		$.ajax({
			method: 'get',
			url: 'http://ec2-54-68-63-145.us-west-2.compute.amazonaws.com/MacroMagic/PHP/daily_intake.php',
			data: {
				'username' : cur_user,
				'day' : cur_day
			},
