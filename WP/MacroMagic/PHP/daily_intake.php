<?php
	...
	echo "<table id = 'Daily_Intake_Table' border = '2'>
	<caption>" . $date->format('F j, Y') . "</caption><tr><th>Nutrients</th><th>Daily Totals</th><th> Daily Goal</th><th>Amount Left</th></tr>";
